...
# s09_download_dragen_gremline_IHCAPX8-3.sh
# Alexey Larionov, 29Nov2020

# Use:
# sbatch s09_download_dragen_gremline_IHCAPX8-3.sh

# Germline BAM and single-sampe VCF and gVCF files
# the total size ~50GB, expected download time ~30min

#SBATCH -J s09_download_dragen_gremline_IHCAPX8-3
...
#SBATCH --ntasks=1
#SBATCH --time=1:00:00
#SBATCH --output=s09_download_dragen_gremline_IHCAPX8-3.log
##SBATCH --qos=INTR
...
# Set folder for data
target_folder="/rds/project/erf33/rds-erf33-medgen/data/wgs_nov_2020/s03_IHCAPX8/s02_dragen_germline/IHCAPX8-3"
