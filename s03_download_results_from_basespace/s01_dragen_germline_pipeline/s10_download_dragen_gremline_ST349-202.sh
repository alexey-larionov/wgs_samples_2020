...
# s10_download_dragen_gremline_ST349-202.sh
# Alexey Larionov, 29Nov2020

# Use:
# sbatch s10_download_dragen_gremline_ST349-202.sh

# Germline BAM and single-sampe VCF and gVCF files
# the total size ~50GB, expected download time ~30min

#SBATCH -J s10_download_dragen_gremline_ST349-202
...
#SBATCH --ntasks=1
#SBATCH --time=1:00:00
#SBATCH --output=s10_download_dragen_gremline_ST349-202.log
##SBATCH --qos=INTR
...
# Set folder for data
target_folder="/rds/project/erf33/rds-erf33-medgen/data/wgs_nov_2020/s04_ST349/s02_dragen_germline/ST349-202"
