...
# s04_bcfstats_ST349_no_filters.sh.sh
# Alexey Larionov, 01Dec2020

# Use:
# sbatch s04_bcfstats_ST349_no_filters.sh.sh

#SBATCH -J s04_bcfstats_ST349_no_filters
...
#SBATCH --output=s04_bcfstats_ST349_no_filters.log
#SBATCH --qos=INTR
...
module load texlive/2015 # for PDF output
...
echo "QC for joint ST349 w/o hard filters"
date
echo ""
...
data_folder="${project_folder}/s03_ST349/s03_dragen_joined_genotyping/s01_short_variants"
vcf_file="${data_folder}/ST349_dragen_joint.vcf.gz"

stats_folder="${project_folder}/s03_ST349/s04_explore_and_qc_short_variant_vcfs/s01_bcfstats_no_filters"
