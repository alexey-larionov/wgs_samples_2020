...
# s05_remove_filtered_variants_from_ST349.sh
# Alexey Larionov, 01Dec2020

# Use:
# sbatch s05_remove_filtered_variants_from_ST349.sh

#SBATCH -J s05_remove_filtered_variants_from_ST349
...
#SBATCH --output=s05_remove_filtered_variants_from_ST349.log
#SBATCH --qos=INTR
...
# Start message
echo "Remove filtered variants from ST349 hard filters"
...
source_folder="${project_folder}/s03_ST349/s03_dragen_joined_genotyping/s01_short_variants"
source_vcf="${source_folder}/ST349_dragen_joint.hard-filtered.vcf.gz"

output_folder="${project_folder}/s03_ST349/s04_explore_and_qc_short_variant_vcfs"
output_vcf="${output_folder}/ST349_short_variants_pf.vcf.gz"

stats_folder="${project_folder}/s03_ST349/s04_explore_and_qc_short_variant_vcfs/s02_bcfstats_filtered"
