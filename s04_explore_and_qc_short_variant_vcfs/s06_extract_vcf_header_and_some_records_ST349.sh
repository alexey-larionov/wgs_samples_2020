...
# s06_extract_vcf_header_and_some_records_ST349.sh
# Alexey Larionov, 01Dec2020

# Use:
# sbatch s06_extract_vcf_header_and_some_records_ST349.sh

#SBATCH -J s06_extract_vcf_header_and_some_records_ST349
...
#SBATCH --output=s06_extract_vcf_header_and_some_records_ST349.log
#SBATCH --qos=INTR
...
source_folder="${project_folder}/s03_ST349/s04_explore_and_qc_short_variant_vcfs"
source_vcf="${source_folder}/ST349_short_variants_pf.vcf.gz"

output_folder="${project_folder}/s03_ST349/s04_explore_and_qc_short_variant_vcfs/s03_extracts_from_vcf"
rm -fr "${output_folder}" # remove folder if existed
mkdir -p "${output_folder}"

vcf_header="${output_folder}/ST349_short_variants_pf_header.txt"
vcf_extract="${output_folder}/ST349_short_variants_pf_extract.txt"
